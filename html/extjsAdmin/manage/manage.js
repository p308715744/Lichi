...
MenuPanel = function() {
	MenuPanel.superclass.constructor.call(this, {
		...
		layoutConfig : {
			...
			items : [ {
				title : '<span><img src="./extjsAdmin/images/user.gif">荔枝用户</span>',
				items : [new ModaUserPanel()]
			}, {
				title : '<span><img src="./extjsAdmin/images/20070417191601429.gif">荔枝视物所</span>',
				items : [new LichiSWSPanel()]
			}, {
				title : '<span><img src="./extjsAdmin/images/20070417191602248.gif">荔枝MV</span>',
				items : [new ModaTalkPanel()]
			}, {
				title : '<span><img src="./extjsAdmin/images/20070417191603848.gif">荔枝通告</span>',
...
//			},
			autoScroll : true,
			tbar : ['欢迎使用荔枝后台管理系统，如有问题请联系维护人员',{text:'联系维护人员!',pressed: true,handler:function(){Ext.MessageBox.alert('提示', '<img src="./extjsAdmin/images/designer_avatar.png" border=0 />隔壁高鹏喊一声~~');}}],
			html : '<img src="./extjsAdmin/images/log2.jpg" border=0 /> part的政策亚克西~~'
		}
	});
};
			...
			header = new Ext.Panel( {
				...
				items : [{
					...
					items : [
							{
								columnWidth : .44,
								html : '<a href=http://lichi.we54.com target=_blank><img src="./extjsAdmin/images/lichilogo.jpg" border=0 height="60px" /></a>'
							},
							{
								columnWidth : .4
							},
