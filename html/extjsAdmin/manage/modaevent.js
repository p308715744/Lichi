...
//			window.showModalDialog('?Controller=ExtjsAdmin&action=NewLichiEvent','addEvent','dialogWidth:880px;dialogHeight:610px;center:yes;help:yes;resizable:yes;status:yes') 
				window.open('?Controller=ExtjsAdmin&action=NewLichiEvent','addEvent',"width=880,height=610")
			/*
